package com.mreturn.zhihudaily.widget;
...
public class RollViewPager extends ViewPager {
    ...
    private List<StoryListBean.TopStoriesBean> topStories;
    ...
    public List<StoryListBean.TopStoriesBean> getTopStories() {
        return topStories;
    }

    public void setTopStories(List<StoryListBean.TopStoriesBean> topStories) {
